...
8. В поле text используй **жирный** для важного и *курсив* для пояснений и названий.
...
Сформулируй понятный ответ на русском с **жирным** для ключевых цифр и *курсивом* для пояснений. type=message, tool=null. Не вызывай инструмент снова."""
